...
/*   Updated: 2023/09/10 23:49:51 by taaraki          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 2.if . is found, remove the current directory 
// 3.if .. is found next, remove the current directory
// 4.malloc to create a new string
// 6.free the first split char array
/*** ***/
...
//@func:
//	create a new path from a path given
//	remove . and .. to create a new string
